...
16. **Falta un flujo unificado "preparar una distribución para un dispositivo"** — las piezas existen todas por separado (`docs/distributions.md` qué instalar, `docs/guides/cfw/<cfw>.md` cómo instalar el CFW, `docs/system-paths.md` dónde van los ficheros, `docs/bios.md`/`docs/guides/bios.md` BIOS, `docs/guides/romsets/workflow.md` preparación del romset, `docs/guides/apps/<frontend>.md` configuración del frontend, sección de bezels/temas de `docs/references.md` + `prompts/theme_bezel_research.md`), pero ningún documento las secuencia de principio a fin para un dispositivo concreto. Verificado 2026-09-06 que no existe ya (no hay `docs/guides/README.md` ni equivalente que las enlace en orden). Pendiente: decidir si esto es un nuevo doc (`docs/guides/device-setup.md` o similar) o una sección añadida a `docs/guides/README.md` (no existe todavía), y su formato (checklist enlazando a cada guía en orden, vs. contenido propio).
