...
| plumOS-GKD      | —        | CFW  | plumOS          | 16 GB | EmulationStation  | Opcional          | Imágenes + vídeos | https://github.com/game-de-it/plumOS-GKD                 | Linux Handheld       | GKD Bubble, GKD Mini Plus                                      | Activo        | Rama plumOS para dispositivos GKD                                    |
...
| DrUm78 RGNano  | —        | CFW  | FunKey          | 4 GB | FunKey UI         | No                | Limitado          | https://rgnano.com/custom-firmware/                      | Linux Handheld       | RGNano                                                        | Activo        | CFW específico para RGNano                                          |
...
| GammaOS | Next | Android CFW | GammaOS | 32 GB | Android Launcher | No | Imágenes + vídeos | https://github.com/TheGammaSqueeze/GammaOSNext | Android | RGVita, RGVita Pro y otros Android compatibles | Activo | Rama moderna; puede requerir acceso de pago o builds específicas por dispositivo |
| GammaOS | Core | Android CFW | GammaOS | 32 GB | Android Launcher | No | Imágenes + vídeos | [TODO] | Android | Anbernic RG ARC-D, RG ARC-S, RG353V, RG353VS, RG353P, RG353PS, RG353M, RG503; PowKiddy RGB30, RGB20SX, RGB10MAX3, RGB20 PRO, X55, X35H, X35S; TrimUI Smart Pro; GameMT E5 Plus, E6 Plus; GKD Bubble; MagicX Zero28; Miyoo Flip; CB408 | Activo | Variante/base ligera; lista de dispositivos compatibles a fecha actual — verificar siempre contra la fuente oficial (proyecto vivo, cambia con frecuencia) |
