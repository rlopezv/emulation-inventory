...
| RogueOS | — | Stock Mod | RogueOS | 4 GB | EmulationStation | Opcional | Imágenes + vídeos | [TODO] | Linux Handheld | GKD Pixel 2 | Activo | Por Ninoh-FOX; hereda drivers de pantalla/energía de fábrica. PortMaster integrado, avisos de batería por vibración al 10%/5% y apagado seguro al 1%, RetroArch actualizado y reproductor de música con pantalla apagada. Arranque de fábrica (~30s) |
