...
| AISLPC R36T Max | RK3326 | OS Handheld | ArkOS4Clone | UnofficialOS / RetroMax OS (stock) | EmulationStation | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs, BIOS, saves | Recomendado | Clon RK3326 no soportado oficialmente por ArkOS/dArkOS/ROCKNIX; requiere el porting de ArkOS4Clone con DTB específico para el panel cuadrado 720x720. UnofficialOS (fork JELOS) confirma soporte oficial como alternativa moderna. RetroMax OS es el firmware de fábrica (EmuELEC 4.7), con reportes de inestabilidad de WiFi. |
