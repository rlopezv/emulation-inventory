...
| Miyoo Miyoo Mini | SSD202D | CFW | Koriki "Bomb" (v1.6.x) | Onion OS (v4.3.x+) / MinUI | SimpleMenu | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs, BIOS, saves | Recomendado | Koriki recomendado; Onion OS como alternativa consolidada. |
...
| Anbernic RG35XX (Original) | ATM7039S | CFW | Koriki "Bomb" | GarlicOS | SimpleMenu | [TODO] | [TODO] | Desconocido | TF1: sistema; TF2: ROMs, BIOS, saves | Recomendado | No confundir con familia H700; GarlicOS como alternativa clásica. |
| Miyoo Miyoo Mini Plus | SSD202D | CFW | Koriki "Bomb" (v1.6.x) | Onion OS (v4.3.x+) / MinUI | SimpleMenu | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs, BIOS, saves | Recomendado | Koriki recomendado; Onion OS como alternativa consolidada. |
...
| Data Frog SF2000 | HCSEMI B210 | Stock Mod | Multicore / Tadpole | Stock mod | Stock UI | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs; backup obligatorio | Válido | Más workflow que CFW completo. |
| Anbernic RGNano | Cortex-A7 | CFW | FunKey OS + DrUm78 (v2.x+) | Stock Anbernic | GMenu2x (DrUm78) | FunKey OS + DrUm78 | GMenu2x (DrUm78) | Verificado | TF1: sistema + ROMs | Recomendado | GMenu2x optimizado por DrUm78; RetroArch Quick Menu para emulación. |
...
| PowKiddy A30 | F1C200S | CFW | MinUI | Stock TrimUI OS modificado (GMenu2X) | MinUI | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs, BIOS, saves | Experimental | Comparte SoC F1C200S con TrimUI Model S; adaptación de MinUI para F1C200S por Shaun Inman. Soporte de comunidad muy escaso — [TODO] validar fiabilidad de estos datos antes de confiar en ellos para instalación real. |
...
| PowKiddy RS-12 | ARM 32-bit | Stock Mod | Stock OS | — | Stock UI | Stock OS | Stock UI | Verificado | TF1: sistema + ROMs | Válido | Dispositivo cerrado; se juega con el firmware de fábrica. |
...
| Miyoo Miyoo Mini Flip | SSD202D | CFW | Koriki "Bomb" (v1.6.x) | spruceOS | SimpleMenu | [TODO] | [TODO] | Desconocido | TF1: sistema + ROMs, BIOS, saves | Recomendado | Depende de madurez de builds. |
| Miyoo Miyoo Flip | RK3566 | CFW | Koriki "Bomb" (v1.6.x) | spruceOS | SimpleMenu | [TODO] | [TODO] | Desconocido | TF1: sistema; TF2: ROMs, BIOS, saves | Recomendado | Depende de madurez de builds. |
...
| Anbernic RGVita (Base) | Unisoc T618 | Frontend | ES-DE Android | Daijishō / Pegasus | ES-DE | [TODO] | [TODO] | Desconocido | Interna: apps + emuladores; TF1: ROMs | Recomendado | Android 12; ES-DE para colecciones ES compatibles. GammaOS Next previsto para este dispositivo. |
| GKD 350H | X1830 | Stock Mod | Stock OpenDingux | — | Stock UI | Stock OpenDingux | Stock UI | Verificado | Interna: sistema + ROMs; TF1: ROMs | Válido | Dispositivo cerrado; no existe CFW para X1830. OpenDingux de fábrica es la única opción. |
...
| Anbernic RG CubeXX | H700 | OS Handheld | KNULLI | muOS / Stock OS | EmulationStation | [TODO] | [TODO] | Desconocido | TF1: sistema; TF2: ROMs, BIOS, saves | Recomendado | KNULLI es ideal aquí porque su interfaz escala perfectamente en pantallas cuadradas 1:1. muOS funciona pero requiere temas adaptados. |
