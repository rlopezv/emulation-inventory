...
| Anbernic RG Rotate | Unisoc T618 | Android CFW | GammaOS Next | ES-DE Android / RGLauncher stock | GammaOS Next, modo Nano (launcher propio) | [TODO] | [TODO] | Desconocido | Interna: apps + emuladores; TF1: ROMs | Recomendado | v1.4.0 introduce el modo "Nano", más ligero, con ajustes propios del mecanismo giratorio (rotar/dormir/lanzar app/reloj); el modo Next completo está a un switch. Coherente con RGVita (mismo SoC T618). |
