...
- **[TODO] Temas y bezels — muy dependientes del dispositivo concreto**: tanto los temas (resolución objetivo, relación de aspecto, si la pantalla es cuadrada/vertical/dual) como los bezels (marco decorativo alrededor de la imagen del juego en RetroArch, dimensionado a la resolución/aspect ratio exactos de la pantalla física) no tienen un tratamiento genérico válido para todos los dispositivos — pendiente de abordar por dispositivo/familia cuando se llegue a ese punto, no antes.
